...
func TestPBLiteZeroIndexLargeIntDeserialization(t *testing.T) {
  ...
  if *pb.OptionalUint64 != 1000000000000000001 {
    t.Errorf("Found %s, want 1000000000000000001", *pb.OptionalUint64)
	}
  if *pb.OptionalInt64 != 1000000000000000001 {
    t.Errorf("Found %s, want 1000000000000000001", *pb.OptionalInt64)
	}
  if *pb.OptionalInt64String != 1000000000000000001 {
    t.Errorf("Found %s, want 1000000000000000001", *pb.OptionalInt64String)
	}
}
...
func TestPBLiteZeroIndexPackageDeserialization(t *testing.T) {
  ...
  if *pb.OptionalInt32 != 1 {
    t.Errorf("Found %s, want 1", *pb.OptionalInt32)
	}
  validateMessage(t, pb.OtherAll)
}
